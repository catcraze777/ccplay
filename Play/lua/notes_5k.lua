...
function notes.note()
	t = {
		...
		group = {
			{id = "section-line", offsets = {3}, dst = {
					{x = property.constants.lane_x_location + property.constants.lane_outline_width, y = property.constants.lane_y_location + property.constants.lane_outline_width, w = property.constants.note_total_width, h = property.constants.lane_outline_width, r = 255, g = 255, b = 255}
				}},
			{id = "section-line", offsets = {3}, dst = {
					{x = property.constants.lane_x_location + property.constants.lane_outline_width, y = property.constants.lane_y_location + property.constants.lane_outline_width, w = property.constants.note_total_width, h = property.constants.lane_outline_width, r = 255, g = 255, b = 255}
				}}
	...
	for i, v in ipairs(property.constants.note_position_x_5key) do
		...
		table.insert(t.dst, {x = v + property.constants.lane_x_location, y = property.constants.note_position_y  + property.constants.lane_y_location, w = property.constants.note_width_5key[i], h = 1080 - property.constants.lane_y_location - property.constants.lane_outline_width})
	end
	return {t}
end
