...
function LaneType.image()
	...
	for i = 1, 5 do
		table.insert(t, {id = "keyflash-"..i, src = "src-keyflash", x = property.constants.note_position_x_5key[i] - property.constants.note_position_x_5key[1], y = 0, w = property.constants.note_width_5key[i], h = 86 } )
	end
	for i = 1, 6 do
		table.insert(t, {id = "keybeam-"..i, src = "src-keybeam", x = property.constants.note_position_x_p1_5key[i] - property.constants.note_position_x_p1_5key[6], y = 0, w = property.constants.note_width_5key[i], h = 460 } )
	end
...
function LaneType.destination()
	...
	for i = 1, 5 do
		table.insert(t, {id = "keyflash-"..i, timer = 100 + i, op = {-80}, blend = 2, loop = 500, dst = {
			{x = property.constants.note_position_x_5key[i] + property.constants.lane_x_location + property.constants.lane_outline_width, y = 258, w = property.constants.note_width_5key[i], h = 86 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 100 + i, op = {-80}, offsets = {3}, loop = 500, dst = {
			{x = property.constants.note_position_x_5key[i] + property.constants.lane_x_location, y = 358, w = property.constants.note_width_5key[i], h = 460 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 120 + i, op = {-80}, offsets = {3}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_5key[i] + property.constants.lane_x_location, y = 358, w = property.constants.note_width_5key[i], h = 460 },
			{time = 70, h = 0}
		} } )
	end
	table.insert(t, {id = "keybeam-6", timer = 100, offsets = {3}, op = {-80}, loop = 500, dst = {
			{x = property.constants.note_position_x_5key[6] + property.constants.lane_x_location, y = 358, w = property.constants.note_width_5key[6], h = 460 }
		} } )
	table.insert(t, {id = "keybeam-6", timer = 120, offsets = {3}, op = {-80}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_5key[6] + property.constants.lane_x_location, y = 358, w = property.constants.note_width_5key[6], h = 460 },
			{time = 70, h = 0}
		} } )
