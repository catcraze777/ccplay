...
function LaneType.image()
	return {
		{id = "key-cover-p1", src = "src-common", x = 1029, y = 0, w = 99, h = 837},
		{id = "key-cover-p2", src = "src-common", x = 1125, y = 0, w = 99, h = 837}
	}
end
...
function LaneType.destination()
	...
	t = {
		{id = "lift", loop = 1000, dst = { 
			...
			{time = 1000, a = 255, x = property.constants.lane_x_location + property.constants.lane_outline_width, y = property.constants.lane_y_location + property.constants.lane_outline_width - property.constants.lane_height_ac, w = property.constants.lane_width_ac - 2 * property.constants.lane_outline_width, h = property.constants.lane_height_ac} 	
		}},
		...
		{id = "green-num-max-int", loop = 1000, op = {270, -271, -273, 177}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 193 + 24 + 4, y = 1080 - 7 - 18 - 20 + 9, w = 6, h = 9, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-int", loop = 1000, op = {270, -271, -273}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 193, y = 1080 - 7 - 18, w = 12, h = 18, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-min-int", loop = 1000, op = {270, 271, 177}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225 - 4, y = 1080 + 7 + 20, w = 6, h = 9, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-max-int", loop = 1000, op = {270, 271, 177}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225 + 24 + 4, y = 1080 + 7 + 20, w = 6, h = 9, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-int", loop = 1000, op = {270, 271}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225, y = 1080 + 7, w = 12, h = 18, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "white-sudden-int", loop = 1000, op = {270, 271}, offset = 4, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 162, y = 1080 + 7, w = 12, h = 18},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "white-hidden-int", loop = 1000, op = {270, 273}, offset = 5, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 162, y = property.constants.lane_y_location + property.constants.lane_outline_width - 7 - 18, w = 12, h = 18},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-min-int", loop = 1000, op = {270, 273, 177}, offset = 5, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225 - 4, y = property.constants.lane_y_location + property.constants.lane_outline_width - 7 - 18 - 20 + 9, w = 6, h = 9, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-max-int", loop = 1000, op = {270, 273, 177}, offset = 5, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225 + 24 + 4, y = property.constants.lane_y_location + property.constants.lane_outline_width - 7 - 18 - 20 + 9, w = 6, h = 9, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
		{id = "green-num-int", loop = 1000, op = {270, 273}, offset = 5, dst = {
			{time = 0, a = 0, x = property.constants.lane_x_location + property.constants.lane_outline_width + 225, y = property.constants.lane_y_location + property.constants.lane_outline_width - 7 - 18, w = 12, h = 18, r = 0, b = 0},
			{time = 1000, a = 0},
			{time = 1000, a = 255}
		}},
