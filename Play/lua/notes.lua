...
function notes.note()
	...
	for i, v in ipairs(property.constants.note_position_x) do
		...
		table.insert(t.dst, {x = v + property.constants.lane_x_location, y = property.constants.note_position_y  + property.constants.lane_y_location, w = property.constants.note_width[i], h = 1080 - property.constants.lane_y_location - property.constants.lane_outline_width})
	end
	return {t}
end
