...
function LaneFrame.destination()
	...
	table.insert(t, {id = "bgaframe-base-video", loop = 500, dst = { 
	...
	if property.customFrame() then
		...
		table.insert(t, {id = "overlay-video", loop = 500, blend = 4, dst = { 
			{time = 0, x = bga_offset + video_x + 1080/4, y = 157 + 810/4, w = 1080/2, h = 810/2, a = 0},
			{time = 250, x = bga_offset + video_x + 1080/16, y = 157 + 810/16, w = 1080 - 1080/2 * 1/4, h = 810 - 810/2 * 1/4, a = 128},
			{time = 375, x = bga_offset + video_x + 1080/64, y = 157 + 810/64, w = 1080 - 1080/2 * 1/16, h = 810 - 810/2 * 1/16, a = 192},
			{time = 500, x = bga_offset + video_x, y = 157, w = 1080, h = 810, a = 255},
	...
	table.insert(t, {id = "bgaframe-video-stripes", loop = 500, op = {2001}, dst = { 
	...
	table.insert(t, {id = "bgaframe-video", op = {2161}, loop = 500, dst = { 
			{time = 0, x = bga_offset + video_x + 1080/4, y = 157 + 810/4, w = 1080/2, h = 810/2, a = 0},
			{time = 250, x = bga_offset + video_x + 1080/16, y = 157 + 810/16, w = 1080 - 1080/2 * 1/4, h = 810 - 810/2 * 1/4, a = 128},
			{time = 375, x = bga_offset + video_x + 1080/64, y = 157 + 810/64, w = 1080 - 1080/2 * 1/16, h = 810 - 810/2 * 1/16, a = 192},
			{time = 500, x = bga_offset + video_x, y = 157, w = 1080, h = 810, a = 255},
		}})
	table.insert(t, {id = -110, loop = 500, stretch = 1, dst = { 
			...
			{time = 250, x = property.constants.bga_x + video_x - 149 + 125 * direction_mult, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 128},
			{time = 375, x = property.constants.bga_x + video_x - 149 + 31 * direction_mult, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 192},
			{time = 500, x = property.constants.bga_x + video_x - 149, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 255},
		}})
	table.insert(t, {id = "bga-disp", loop = 500, stretch = 1, op = {41}, dst = { 
			{time = 0, x = property.constants.bga_x + video_x - 149 + 500 * direction_mult, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 0},
			{time = 250, x = property.constants.bga_x + video_x - 149 + 125 * direction_mult, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 128},
			{time = 375, x = property.constants.bga_x + video_x - 149 + 31 * direction_mult, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 192},
			{time = 500, x = property.constants.bga_x + video_x - 149, y = 0 + property.constants.bga_y, w = property.constants.bga_w, h = property.constants.bga_h, a = 255},
