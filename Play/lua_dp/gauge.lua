...
function Gauge.destination()
	...
	if property.grooveGaugeRainbow() then
		...
		table.insert(t, {id = "groove_rainbow_2", loop = 1000, draw = function() return (main_state.gauge_type() == 2) end, dst = { {time = 0, x = property.constants.groove_gauge_x, y = property.constants.groove_gauge_y, w = gauge_width, h = 40, a = 0}, {time = 500, a = 0}, {time = 1000, a = 255} }})
		table.insert(t, {id = "groove_rainbow_3", loop = 1000, draw = function() return (main_state.gauge_type() >= 3) end, dst = { {time = 0, x = property.constants.groove_gauge_x, y = property.constants.groove_gauge_y, w = gauge_width, h = 40, a = 0}, {time = 500, a = 0}, {time = 1000, a = 255} }})
		table.insert(t, {id = "groove_rainbow_4", loop = 1000, draw = function() return (main_state.gauge_type() == 0) end, dst = { {time = 0, x = property.constants.groove_gauge_x, y = property.constants.groove_gauge_y, w = gauge_width, h = 40, a = 0}, {time = 500, a = 0}, {time = 1000, a = 255} }})
		table.insert(t, {id = "groove_rainbow_5", loop = 1000, draw = function() return (main_state.gauge_type() == 1) end, dst = { {time = 0, x = property.constants.groove_gauge_x, y = property.constants.groove_gauge_y, w = gauge_width, h = 40, a = 0}, {time = 500, a = 0}, {time = 1000, a = 255} }})
	end
	table.insert(t, {
			id = "groove-gauge", loop = 1000, dst = {
				{time = 0, a = 0, x = property.constants.groove_gauge_x, y = property.constants.groove_gauge_y, w = gauge_width, h = 40},
				{time = 500, a = 0},
				{time = 1000, a = 255}
			}
		} )
