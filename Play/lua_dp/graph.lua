...
function Graph.destination()
	t = {}
	local graph_x = property.constants.bga_frame_x_p1 + 45
	local direction = 1
	if not property.graphLeftSide() then
		graph_x = property.constants.bga_frame_x_p2 + 44
		direction = -1
	end
	local graph_y = 58
	...
	-- Target graph & Personal Best
		-- Draw these if personal best exists.
	local_func = function() return (main_state.number(150) > 0) and skin_config.option["Graph Personal Best Only"] == 2031 end
	table.insert(t, {id = "graph-score", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67, y = graph_y, w = 66, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67, y = graph_y, a = 255},
		}})
	table.insert(t, {id = "graph-pb-ghost", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 77, y = graph_y, w = 66, h = 0, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 77, y = graph_y, h = 810, a = 255},
		}})
	table.insert(t, {id = "graph-pb", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 77, y = graph_y, w = 66, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 77, y = graph_y, a = 255},
		}})
	table.insert(t, {id = "graph-target-ghost", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 154, y = graph_y, w = 66, h = 0, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 154, y = graph_y, h = 810, a = 255},
		}})
	table.insert(t, {id = "graph-target", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 154, y = graph_y, w = 66, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 154, y = graph_y, a = 255},
		}})
		-- Draw these if personal best does not exist.
	local_func = function() return (main_state.number(150) == 0) and skin_config.option["Graph Personal Best Only"] == 2031 end
	table.insert(t, {id = "graph-score", loop = 1650, op = {2012, 2031}, draw = local_func, dst = { 
	...
	-- Personal Best only
		-- Draw these if personal best exists.
	local_func = function() return (main_state.number(150) > 0) and skin_config.option["Graph Personal Best Only"] == 2032 end
	table.insert(t, {id = "graph-score", loop = 1650, op = {2012, 2032}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67, y = graph_y, w = 100, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67, y = graph_y, a = 255},
		}})
	table.insert(t, {id = "graph-pb-ghost", loop = 1650, op = {2012, 2032}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 120, y = graph_y, w = 100, h = 0, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 120, y = graph_y, h = 810, a = 255},
		}})
	table.insert(t, {id = "graph-pb", loop = 1650, op = {2012, 2032}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 120, y = graph_y, w = 100, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 120, y = graph_y, a = 255},
		}})
		-- Draw these if personal best does not exist.
	local_func = function() return (main_state.number(150) == 0) and skin_config.option["Graph Personal Best Only"] == 2032 end
	table.insert(t, {id = "graph-score", loop = 1650, op = {2012, 2032}, draw = local_func, dst = { 
			{time = 0 + 1400, x = graph_x + 67 + 35, y = graph_y, w = 150, h = 810, a = 0},
			{time = 250 + 1400, x = graph_x + 67 + 35, y = graph_y, a = 255},
		}})
		
	-- Score text values.
		-- Personal Best exists.
	table.insert(t, {id = "graph_score_best_text", loop = 1950, op = {2012}, draw = function() return main_state.number(150) > 0 end, dst = { 
			{time = 0 + 1700, x = graph_x + 75, y = graph_y + 5, w = 114, h = 25, a = 0},
			{time = 250 + 1700, a = 255},
		}})
	table.insert(t, {id = "graph_score_best_value", loop = 1950, op = {2012}, draw = function() return main_state.number(150) > 0 end, dst = { 
	...
	-- Color flashes for PB, Target, and A/AA/AAA reaches.
	...
	table.insert(t, {id = -111, loop = 500, timer = 351, op = {2012}, draw = function() return (main_state.number(150) > 0) end, blend = 2, dst = { 
