...
function LaneType.destination()
	...
	for i = 1, 5 do
		table.insert(t, {id = "keyflash-"..i, timer = 100 + i, op = {-80}, blend = 2, loop = 500, dst = {
			{x = property.constants.note_position_x_p1_5key[i] + property.constants.lane_x_location_p1 + property.constants.lane_outline_width, y = 258, w = property.constants.note_width[i], h = 86 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 100 + i, op = {-80}, offsets = {3}, loop = 500, dst = {
			{x = property.constants.note_position_x_p1_5key[i] + property.constants.lane_x_location_p1, y = 358, w = property.constants.note_width[i], h = 460 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 120 + i, op = {-80}, offsets = {3}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_p1_5key[i] + property.constants.lane_x_location_p1, y = 358, w = property.constants.note_width[i], h = 460 },
			{time = 70, h = 0}
		} } )
	end
	table.insert(t, {id = "keybeam-6", timer = 100, offsets = {3}, op = {-80}, loop = 500, dst = {
			{x = property.constants.note_position_x_p1_5key[6] + property.constants.lane_x_location_p1, y = 358, w = property.constants.note_width[8], h = 460 }
		} } )
	table.insert(t, {id = "keybeam-6", timer = 120, offsets = {3}, op = {-80}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_p1_5key[6] + property.constants.lane_x_location_p1, y = 358, w = property.constants.note_width[8], h = 460 },
			{time = 70, h = 0}
		} } )
	...
	for i = 1, 5 do
		table.insert(t, {id = "keyflash-"..i, timer = 110 + i, op = {-80}, blend = 2, loop = 500, dst = {
			{x = property.constants.note_position_x_p2_5key[i] + property.constants.lane_x_location_p2 + property.constants.lane_outline_width, y = 258, w = property.constants.note_width[i], h = 86 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 110 + i, op = {-80}, offsets = {3}, loop = 500, dst = {
			{x = property.constants.note_position_x_p2_5key[i] + property.constants.lane_x_location_p2, y = 358, w = property.constants.note_width[i], h = 460 }
		} } )
		table.insert(t, {id = "keybeam-"..i, timer = 130 + i, op = {-80}, offsets = {3}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_p2_5key[i] + property.constants.lane_x_location_p2, y = 358, w = property.constants.note_width[i], h = 460 },
			{time = 70, h = 0}
		} } )
	end
	table.insert(t, {id = "keybeam-6", timer = 110, offsets = {3}, op = {-80}, loop = 500, dst = {
			{x = property.constants.note_position_x_p2_5key[6] + property.constants.lane_x_location_p2, y = 358, w = property.constants.note_width[8], h = 460 }
		} } )
	table.insert(t, {id = "keybeam-6", timer = 130, offsets = {3}, op = {-80}, loop = 500, loop = 70, dst = {
			{time = 0, x = property.constants.note_position_x_p2_5key[6] + property.constants.lane_x_location_p2, y = 358, w = property.constants.note_width[8], h = 460 },
			{time = 70, h = 0}
		} } )
	table.insert(t, {id = "judgeline", offsets = {3}, loop = 1200, dst = { 
